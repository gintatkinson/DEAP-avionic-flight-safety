...
This profile acts as one of the swappable backends under the abstract architecture defined in [feat-domain-decoupling-solution.md](https://github.com/gintatkinson/DEAP-spec-core/blob/main/docs/architecture/profiles/feat-domain-decoupling-solution.md). It satisfies the following goals:
