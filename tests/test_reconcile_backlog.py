...
def test_sanitize_source_references_converts_file_uris():
    content = "Reference: file:///Users/perkunas/jail/UAS-001/deap_repos/digital-pipeline-repo/docs/spec.md"
    workspace = "/Users/perkunas/jail/UAS-001/deap_repos/digital-pipeline-repo"
    sanitized = sanitize_source_references(content, workspace_dir=workspace)
